...
<pre class="wp-block-code"><code>D' R* // DR-4c4e (2/7) -> (F2 D' L' &#91;F2 D2 R*, B2 U2 L*]) // DR (6/13)
L2 D* // DR-4c2e (2/7) -> {D} L D2 R' B2 R2 D R2 D* // DR (8/15)
(D' L*) // DR-4c2e (2/7)
B2 R' U* // DR-4c4e (2/7) -> {U} L U2 B2 L D* // DR (5/12)</code></pre>
