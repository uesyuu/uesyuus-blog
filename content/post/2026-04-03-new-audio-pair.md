...
> 追記:</br>
> 2026年9月にオーディオペアのナンバリングを一部変更しました。</br>
> 記事の末尾に変更点を追記してあります。
...
ナンバリングを一部変更したので追記します。

具体的には、母音+母音のペアを拗音(例: きゃきゅきょ)に変更しました。

ルールとしては以下のようなものになります。

- 母音+母音(a,u,o)は、1文字目の母音の代替子音を使って拗音にする
  - 例: UR-ULは[ky, u]で「キュ」
- 母音+eは、1文字目の代替子音+1文字目の母音にする
  - 例: UR-UBは[ky, e]になるが、eのため[ky, a]となり「キャ」
- 母音+iは、by+1文字目の母音にする
  - 例: UR-UBは[ky, i]になるが、iのため[by, a]となり「ビャ」
- ie, eiはそのままだが、3BLDのエッジには出現しない

1レイヤー目の代替子音は以下の画像の通りです。

<img src="/images/2026/04/1layer_new.png" width="500" />
